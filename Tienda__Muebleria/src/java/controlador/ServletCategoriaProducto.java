 ...
 * @author PARIS
 */
@WebServlet(name = "ServletCategoriaProducto", urlPatterns = {"/ServletCategoriaProducto", "/catProducListar"})
public class ServletCategoriaProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.equals("/catProducListar")) {
