...
import modelo.dao.CategoriaGeneralDAO;

/**
 *
 * @author PARIS
 */
@WebServlet(name = "ServletCategoriaGeneral", urlPatterns = {"/ServletCategoriaGeneral", "/catGenListar"})
public class ServletCategoriaGeneral extends HttpServlet {
