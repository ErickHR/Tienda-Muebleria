...
import modelo.dao.SubCategoriaProductoDAO;

/**
 *
 * @author PARIS
 */
@WebServlet(name = "ServletSubCategoriaProducto", urlPatterns = {"/ServletSubCategoriaProducto", "/SubCatProdlistarxCatProd"})
public class ServletSubCategoriaProducto extends HttpServlet {
